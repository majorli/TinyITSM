			...
			<div class="easyui-panel" data-options="title:'新增信息化资产',width:'100%',height:'100%'" style="padding:2em;">
				<form action="" method="post" id="newSystem">
					<div class="MidLine">
						...
						<label class="R">系统状态：</label><input id="v_stage" class="easyui-combobox" data-options="data:[{'id':0,'text':'建设阶段'},{'id':1,'text':'正常使用'}],valueField:'id',textField:'text',editable:false,required:true,missingMessage:'系统状态必须选择',height:30" />
					</div>
					<div class="MidLine">
