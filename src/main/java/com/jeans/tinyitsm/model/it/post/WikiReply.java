...
public class WikiReply extends Post {
	...
	public String toString() {
		...
		builder.append("WikiReply [page=").append(page.getTitle()).append(", listOrder=").append(listOrder).append("]");
